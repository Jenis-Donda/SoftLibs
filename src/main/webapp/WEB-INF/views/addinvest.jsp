...
<head>
    ...
    <!-- Title Page-->
    <title>	Add Investment Software</title>
        ...
        <div class="container py-5 h-100">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-lg-8 col-xl-6">
              <div class="card ">
                <img
                  src="https://www.hp.com/us-en/shop/app/assets/images/uploads/prod/10-Best-Free-Drawing-Software-Programs16746752375285.jpg"
                  class="w-100"
                ...
                <br>
                  <form class="px-md-2" action="addinv" method="POST">
