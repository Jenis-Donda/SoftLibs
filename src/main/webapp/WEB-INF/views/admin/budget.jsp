...
<title>Admin-Budget | SoftLib</title>
	...
	<div class="container py-5">
		...
		<div class="row text-center text-white mb-5">
			<div class="col-lg-7 mx-auto">
				<h1 class="display-4">Budget Softwares</h1>
			</div>
		</div>
		<div class="row">
						...
						<li class="list-group-item mt-2" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;">
							...
							<div
								...
								<div class="media-body order-2 order-lg-1">
									...
									<a href="deletebud/${b.id }">  <button class="btn btn-danger btn-sm rounded-0 mt-0 mb-0 " type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i> Remove</button></a>
								</div>
								<img src="getimagebud/<c:out value='${b.id}'/>"
